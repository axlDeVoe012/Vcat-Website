      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12 md:mb-20">
          ...
          <div className="bg-white p-6 md:p-8 border border-gray-100 rounded-xl shadow-sm hover:shadow-lg transition text-center group">
            <div className="w-14 h-14 md:w-16 md:h-16 bg-blue-50 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 text-brand-blue group-hover:bg-brand-blue group-hover:text-white transition">
              <Target size={28} />
            </div>
          ...
          {/* Vision */}
          <div className="bg-white p-6 md:p-8 border border-gray-100 rounded-xl shadow-sm hover:shadow-lg transition text-center group">
            <div className="w-14 h-14 md:w-16 md:h-16 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 text-brand-red group-hover:bg-brand-red group-hover:text-white transition">
              <Eye size={28} />
            </div>
        ...
        <div className="bg-brand-black text-white rounded-2xl p-6 md:p-12 overflow-hidden relative shadow-2xl">
          {/* Decorative Circle */}
          <div className="absolute top-0 right-0 w-48 h-48 md:w-64 md:h-64 bg-gray-800 rounded-full -mr-24 md:-mr-32 -mt-24 md:-mt-32 opacity-50"></div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            ...
            <div className="w-36 h-36 md:w-48 md:h-48 bg-gray-700 rounded-full flex items-center justify-center shrink-0 border-4 border-brand-red shadow-lg overflow-hidden">
               <span className="text-gray-400 font-bold text-center text-sm md:text-base px-2">
                 Director<br/>Photo
               </span>
            </div>
            
            <div className="text-center md:text-left">
              <h2 className="text-xl md:text-2xl font-bold mb-2">Management Profile</h2>
              <div className="w-16 md:w-20 h-1 bg-brand-red mb-4 md:mb-6 mx-auto md:mx-0"></div>
              
              <h3 className="text-lg md:text-xl font-semibold mb-2">{COMPANY_INFO.director}</h3>
              <p className="text-gray-400 mb-4 md:mb-6 leading-relaxed max-w-2xl text-sm md:text-base">
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                <span className="border border-gray-600 px-2 md:px-3 py-1 rounded-full text-xs text-gray-300">Public Relations N6</span>
                <span className="border border-gray-600 px-2 md:px-3 py-1 rounded-full text-xs text-gray-300">Business Management</span>
                <span className="border border-gray-600 px-2 md:px-3 py-1 rounded-full text-xs text-gray-300">IT Certificate</span>
              </div>
            </div>
          </div>
        </div>
